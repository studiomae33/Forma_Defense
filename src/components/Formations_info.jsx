  ...
  return (
    <section className="bg-gray-50 py-16 w-full">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <div>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-700 mb-2 tracking-tight">FORMATION&nbsp;: <span className="text-slate-900">Négociation de crise</span></h2>
          <p className="text-lg text-slate-700 mb-6 leading-relaxed">
            Formation 100% présentiel pour apprendre à gérer les conflits, maîtriser les techniques de négociation de crise et développer des stratégies de résolution. Animée par <span className="font-bold text-blue-700">Didier GUEGUEN</span>, négociateur du RAID, cette formation s’adresse aux personnes en contact avec le public, étudiants en sécurité et professionnels du secteur.
          </p>
        </div>
