...
const avis = [
	{
		name: 'Maela C',
		text: "Expérience géniale ! Une formation enrichissante autant sur le point de vue pratique que théorique, avec des intervenants de qualité et des conseils adaptés. Mention spéciale à la partie pratique !",
		stars: 5,
	},
	{
		name: 'Laure S',
		text: "Formation très complète, équipe pédagogique au top ! Au plaisir de vous retrouver pour d'autres formations !",
		stars: 5,
	},
	{
		name: 'Germain D',
		text: "Excellente formation. J’ai appris énormément de choses durant ces 3 mois ! Avec de très bons formateurs. Je recommande !",
		stars: 5,
	},
]
  ...
  Voir tous les avis Google
				...
				<div className="flex-1 flex flex-col gap-4 items-center relative">
					<div className="flex flex-col md:flex-row gap-4 w-full">
						{avis.map((a, i) => (
							<div key={i} className={`relative bg-white border border-blue-100 rounded-xl shadow p-5 flex-1 flex flex-col items-center text-center transition hover:scale-105 duration-200 max-w-xs mx-auto ${i === 1 ? 'md:mt-4' : ''}`}>
